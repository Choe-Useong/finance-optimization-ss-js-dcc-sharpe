...
논문링크: https://koreascience.kr/article/CFKO202532454070485.view
## 개요

본 프로젝트는 기대수익률·공분산의 시변성과 추정 오차를 반영해 포트폴리오를 최적화합니다.
상태공간, James–Stein, DCC-GARCH를 결합해 샤프비율 최대화를 수행하고 성과를 평가합니다.

## 서론

본 연구는 포트폴리오 최적화에서 나타나는 세 가지 문제를 다룹니다.

### 1. 기대수익률의 시변성

시장 국면 전환과 구조 변화로 자산의 기대수익률은 시간에 따라 달라지며, 고정 평균 가정은 이를 충분히 반영하지 못할 수 있습니다.

### 2. 기대수익률 추정 오차와 극단화

표본 기반 기대수익률 추정치는 잡음에 민감해 오차가 크고, 최적화 과정에서 특정 자산으로 쏠리는 극단적 해를 유발할 수 있습니다.

### 3. 공분산 구조의 시변성

시장 국면 변화에 따라 변동성과 상관관계가 달라지므로, 고정 공분산 가정은 위험을 과소·과대평가할 수 있습니다.
