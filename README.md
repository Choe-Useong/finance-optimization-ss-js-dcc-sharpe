...
첫째, 기대수익률 추정의 불안정성입니다. 표본 기반 추정치는 잡음에 민감해 작은 오차가 최적 가중치를 크게 왜곡할 수 있습니다.  
둘째, 추정치의 극단화 문제입니다. 평균 추정치가 과도하게 퍼지면 특정 자산으로 쏠리는 비현실적 해가 발생하기 쉽습니다.  
셋째, 공분산 구조의 시변성입니다. 시장 국면 변화에 따라 변동성과 상관관계가 달라지므로, 고정 공분산 가정은 위험을 과소·과대평가할 수 있습니다.
